            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card bg-c-blue order-card">
                        <div class="card-body">
                            ...
                            <h2 class="text-left"><span>486</span><i class="feather icon-shopping-cart float-right"></i>
                            </h2>
                ...
                <div class="col-md-6">
                    <div class="card bg-c-green order-card">
                        <div class="card-body">
                            ...
                            <h2 class="text-left"><span>1641</span><i class="feather icon-shopping-cart float-right"></i>
                            </h2>
                ...
                <div class="col-md-6">
                    <div class="card mrr-card">
                        ...
                        <div id="average-chart11" class="position-absolute bottom-chart" style="height:145px;width:100%;">
                        </div>
                        <div class="card-body">
                            <h3 class="m-0">$80</h3>
                            <span>Goal: $75</span>
                ...
                <div class="col-md-6">
                    <div class="card mrr-card">
                        ...
                        <div id="average-chart12" class="position-absolute bottom-chart" style="height:145px;width:100%;">
                        </div>
                        <div class="card-body">
                            <h3 class="m-0">$80</h3>
                            <span>Goal: $75</span>
                ...
                <div class="card-block border-bottom">
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col text-right">
                            <h3>12,281</h3>
                            <h5 class="text-c-blue mb-0">+7.2% <span class="text-muted">Total
                                    Likes</span></h5>
                        </div>
                    </div>
                </div>
                <div class="card-block">
                    <div class="row align-items-center justify-content-center card-active">
                        <div class="col-6">
                            ...
                            <div class="progress">
                                <div class="progress-bar progress-c-blue" role="progressbar" style="width:60%;height:6px;"
                        ...
                        <div class="col-6">
                            ...
                            <div class="progress">
                                <div class="progress-bar progress-c-green" role="progressbar" style="width:45%;height:6px;"
            ...
            <div class="card card-social">
                <div class="card-block border-bottom">
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col text-right">
                            <h3>11,200</h3>
                            <h5 class="text-c-info mb-0">+6.2% <span class="text-muted">Total
                                    Likes</span></h5>
                        </div>
                    </div>
                </div>
            ...
            <div class="card user-card">
                ...
                <div class="card-body  text-center">
                    ...
                    <div class="row justify-content-center user-social-link">
                        <div class="col-auto"><a href="#!"><i class="fab fa-facebook-f text-primary f-22"></i></a>
                        </div>
