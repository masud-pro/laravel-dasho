        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5>Edit Category Info</h5>
                    <a href="{{ route('categories.index') }}" class="btn btn-glow-dark btn-dark flot-r">Back</a>
                </div>
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                                    id="exampleFormControlTextarea1" rows="4" placeholder="Enter description">{{ old('description') ?? $category->description }}</textarea>
